...
COLS = [
    ...
    ("Surveys 2020–2025", "teaching years 2019–2024",
     ...
     [("2300", "Preschool & kindergarten"),
      ...
      ("2320", "Secondary school"),
      ("2330", "Special education"),
      ("2360", "Other teachers & instructors")]),
]
...
NOTES = [
    ...
    ("Yes", "for people, but only two years: the CPS links the same person across two consecutive "
            "March interviews (PERIDNUM); postsecondary instructors and teaching assistants are never included."),
]
...
ax.text(0.045, 0.255, "Are the codes traceable across census years?",
