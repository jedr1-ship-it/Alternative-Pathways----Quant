...
- **New Mexico.** What does the retirement board's approval consist of, and what
  happens when the months allowed run out?
- **Louisiana.** Removing the retirement-date cut-off looks small on paper and
  large in effect. What did it change, and how does a district certify a
  shortage?
- **North Carolina.** Why was the 1999–2009 policy allowed to lapse, and what
  would it take to revisit it?
- **Virginia.** Acting on the licence rather than the pension: what did that
  change for retirees, and where does it stand now?
